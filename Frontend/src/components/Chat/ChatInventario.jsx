...
export default function ChatInventario() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header mejorado */}
      <div className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-cyan-600 to-teal-600 p-6 shadow-xl">
          ...
          <div className="relative h-full overflow-y-auto p-6 space-y-6 chat-scrollbar">
                  ...
                  <div
                    className={`relative group rounded-2xl px-5 py-4 shadow-lg transition-all duration-300 ${
                      mensaje.tipo === "usuario"
                        ...
                        : "bg-white text-gray-800 border-2 border-blue-100 rounded-tl-sm hover:border-blue-200 hover:shadow-xl"
                    }`}
                  >
                    {mensaje.tipo === "asistente" && (
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/0 via-blue-500/10 to-blue-500/0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    )}
            ...
            {loading && (
              <div className="flex items-start gap-4 animate-fadeIn">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-cyan-600 text-white flex items-center justify-center shadow-lg">
                  <FaBox className="text-sm" />
                </div>
                <div className="flex flex-col items-start max-w-[75%]">
                  <div className="relative bg-white border-2 border-blue-100 rounded-2xl rounded-tl-sm px-5 py-4 shadow-lg">
      ...
      {/* Input mejorado */}
      <div className="relative">
        <div className="flex gap-3 items-end bg-white rounded-2xl border-2 border-gray-200 shadow-lg p-4 hover:border-blue-300 transition-colors">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed text-gray-800 placeholder-gray-400"
              disabled={loading}
            />
